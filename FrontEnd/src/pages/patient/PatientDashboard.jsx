    ...
    <div ref={containerRef} className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-surface-500 mt-1">Welcome back, here's your health summary.</p>
        </div>
        <Link to="/patient/book-appointment" className="btn-primary flex items-center justify-center gap-2">
      ...
      <div className="card overflow-hidden border border-surface-100 shadow-card">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-surface-900">Recent Appointments</h2>
          <Link to="/patient/appointments" className="text-sm font-semibold text-primary-600 hover:text-primary-700">View All</Link>
        </div>
        ...
        {recentAppointments.length === 0 ? (
          <div className="text-center py-12 bg-surface-50 rounded-xl border border-dashed border-surface-200">
            ...
            <Link to="/patient/book-appointment" className="text-primary-600 hover:underline mt-2 inline-block text-sm">Book your first visit</Link>
          </div>
        ) : (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-surface-500">General Physician</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
